...
#' `sm_test` module (internal documentation)
#'
#' This is the internal documentation of your module that is not included in the
#' help index of the package. For a [user-facing help page][sm_test],
...
#' `SIAtools::preview_module("sm_test")`.
#'
...
#' @rdname sm_test_internal
#'
sm_test_server <- function(id, imports = NULL, ...) {
